...
def get_top_10(df, sport):
    ...
    top_10_counts = temp['Name'].value_counts().reset_index()
    top_10_counts.columns = ['Name', 'Medals']
    
    # Merge with original DataFrame to get additional information
    top_10 = top_10_counts.head(10).merge(df, on='Name', how='left').drop_duplicates(subset=['Name'])
    
    # Select relevant columns
    top_10 = top_10[['Name', 'Medals', 'Sex', 'region']]
